...
namespace Lab.ShoppingBasket.ServiceTest
{
    ...
    public class BasketServiceTest
    {
        ...
        public void Basket1()
        {
            ...
            // act 
            var basketServiceResponse = basetService.GetBasketTotal(baset);

            // assert
            Assert.AreEqual(60.15, basketServiceResponse.BasketValue);
        ...
        public void Basket2()
        {
            ...
            var baset = new Basket
            {
                Products = new List<Product>
                {
                    _productRepository.GetProduct(3),
                    _productRepository.GetProduct(4)
                },
            ...
            // assert
            Assert.AreEqual(51.00, basketServiceResponse.BasketValue);
        ...
        public void Basket3()
        {
            ...
            var baset = new Basket
            {
                Products = new List<Product>
                {
                    _productRepository.GetProduct(3),
                    _productRepository.GetProduct(4),
                    _productRepository.GetProduct(5)
                },
                OfferVoucher = _offerVoucherRepository.GetOffVoucher(1)
            };
            var basetService = new BasketService(_basketProcessorFactory);
        ...
        public void Basket4()
        {
            ...
            // assert
            Assert.AreEqual(41.00, basketServiceResponse.BasketValue);
            Assert.AreEqual(0, basketServiceResponse.Notifications.Count);
        }
        ...
        public void Basket5()
        {
            ...
            var baset = new Basket
            {
                ...
                {
                    _productRepository.GetProduct(3),
                    _productRepository.GetProduct(6)
                },
                OfferVoucher = _offerVoucherRepository.GetOffVoucher(2)
            };
            var basetService = new BasketService(_basketProcessorFactory);
            ...
            // assert
            Assert.AreEqual(55.00, basketServiceResponse.BasketValue);
            Assert.AreEqual(1, basketServiceResponse.Notifications.Count);
